...
## Examples
For detailed examples on how to use this module, please refer to the [Examples](https://github.com/pankajyadavdevops/terraform-google-subnet/tree/master/example) directory within this repository.
...
## License
This project is licensed under the **MIT** License - see the [LICENSE](https://github.com/pankajyadavdevops/terraform-google-subnet/blob/master/LICENSE) file for details.
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_labels"></a> [labels](#module\_labels) | git::https://github.com/pankajyadavdevops/terraform-google-labels.git?ref=v1.0.0 | 1.0.2 |
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repository. | `string` | `"https://github.com/pankajyadavdevops/terraform-google-subnet"` | no |
